...
```{python}
# ========== 画收盘价 + 两条均线 ==========
plt.figure(figsize=(9.6, 4.8))  # 创建画布
...
```{python}
# ========== 金叉死叉标注图 ==========
fig, ax = plt.subplots(figsize=(10.8, 6))  # 创建子图
...
fig, axes = plt.subplots(2, 1, figsize=(10.8, 7.2), sharex=True,  # 创建子图
...
fig, ax = plt.subplots(figsize=(10.8, 4.8))  # 创建子图
