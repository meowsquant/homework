...
fig, axes = plt.subplots(2, 1, figsize=(9.6, 6), sharex=True)  # 2行1列子图，共用横轴
...
plt.figure(figsize=(9.6, 4.8))                     # 创建画布，宽8高4英寸
...
fig, axes = plt.subplots(1, 3, figsize=(12, 4.8))  # 1行3列，三个子图
...
fig, axes = plt.subplots(1, 3, figsize=(12, 4.8))  # 三个玩家各一张子图
